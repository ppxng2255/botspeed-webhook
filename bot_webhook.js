...
const regions = {
    ...
    "กลาง": ["พิษณุโลก", "พิจิตร", "เพชรบูรณ์", "นครสวรรค์", "อุทัยธานี", "กำแพงเพชร", "สุโขทัย", "สมุทรสาคร",
                                "สมุทรปราการ", "สมุทรสงคราม", "นครปฐม", "กรุงเทพมหานคร", "นนทบุรี", "ปทุมธานี",
...
function askLocation(req, res) {
    ...
    if (!Object.values(regions).flat().includes(location)) {
        res.json({
            fulfillmentText: `ขออภัยค่ะ น้อง Speedโม่ไม่พบจังหวัด "${location}" กรุณาระบุจังหวัดที่ถูกต้องค่ะ!`
        });
        return;
    }
