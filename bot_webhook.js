...
const responseUnknown = [
    "😅 ดูเหมือนว่าคำตอบของพี่ๆ จะไม่ตรงกับสิ่งที่ Speedโม่ต้องการค่ะ \n ลองพิมพ์ใหม่อีกครั้งค่า ",
    "ขอโทษค่า น้องโม่ยังไม่เข้าใจคำตอบนี้ค่ะ กรุณาตอบใหม่ เช่น พิมพ์ชื่อจังหวัด หรือพิมพ์ 'ไม่' เพื่อจบการสนทนา",
    "ขอโทษกั้บป๋ม 😢 น้องSpeedโม่ ยังไม่รองรับคำตอบนี้ ลองพิมพ์จังหวัดที่ต้องการได้เลยค่ะ!"
];
...
function handleUnknown(req, res) {
    res.json({
        fulfillmentText: responseUnknown[Math.floor(Math.random() * responseUnknown.length)]
    });
}
...
app.post("/webhook", (req, res) => {
    ...
    if (intentMap.has(intent)) {
        ...
        handleUnknown(req, res); // ถ้าไม่มี Intent ที่ตรงกัน → ตอบกลับว่าไม่เข้าใจ
